...
LISTA_COMPLETA_DE_ARQUIVOS="exerA.f90 exerB.f90 grafA.pdf grafB.pdf tabA1_out.dat"

# Caminho completo da pasta de destino no servidor
PASTA_DE_DESTINO="/public/fiscomp2025-2-guilherme/proj6/proj6_${NUMERO_USP}"
