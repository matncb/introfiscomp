...
LISTA_COMPLETA_DE_ARQUIVOS="exer1.f90 exer2.f90 trajexata.txt exer3A.f90 exer3B.f90 graf3.pdf"

# Caminho completo da pasta de destino no servidor
PASTA_DE_DESTINO="/public/fiscomp2025-2-guilherme/proj3/proj3_${NUMERO_USP}"
